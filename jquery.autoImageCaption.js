/**
 * Auto image caption with text from the title attribute and creates a caption
 * Options:
 *	- wrapper (object): 
 *		- tag (string)
 *		- class (string)
...
(function($) {
  ...
  $.fn.autoImageCaption = function(options) {
    ...
    //compares defaults and user input, user input will overwrite default
    ...
    $.each(opts, function validateOptions(key, val) {
      if (key === "wrapper" || key === "caption") {
        ...
        if (
          ...
          val.class.match(tagClassRE) === null
        ) {
